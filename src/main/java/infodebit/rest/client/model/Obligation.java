 ...
 * Obligație detaliat
 */
@ApiModel(description = "Obligație detaliat")
...
public class Obligation {
  ...
  public static final String SERIALIZED_NAME_MDL_EQUIVALENT_AMOUNT = "mdlEquivalentAmount";
  @SerializedName(SERIALIZED_NAME_MDL_EQUIVALENT_AMOUNT)
  private BigDecimal mdlEquivalentAmount;
  ...
  public Obligation amount(BigDecimal amount) {
  ...
  **/
  ...
  public Obligation mdlEquivalentAmount(BigDecimal mdlEquivalentAmount) {
    
    this.mdlEquivalentAmount = mdlEquivalentAmount;
    return this;
  }

   /**
   * Get mdlEquivalentAmount
   * @return mdlEquivalentAmount
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public BigDecimal getMdlEquivalentAmount() {
    return mdlEquivalentAmount;
  }


  public void setMdlEquivalentAmount(BigDecimal mdlEquivalentAmount) {
    this.mdlEquivalentAmount = mdlEquivalentAmount;
  }


  public Obligation currencyCode(Integer currencyCode) {
  ...
  **/
  ...
  public Obligation description(String description) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.amount, obligation.amount) &&
        Objects.equals(this.mdlEquivalentAmount, obligation.mdlEquivalentAmount) &&
        Objects.equals(this.currencyCode, obligation.currencyCode) &&
        Objects.equals(this.description, obligation.description);
  }

  @Override
  public int hashCode() {
    return Objects.hash(amount, mdlEquivalentAmount, currencyCode, description);
  }
  ...
  public String toString() {
    ...
    sb.append("    mdlEquivalentAmount: ").append(toIndentedString(mdlEquivalentAmount)).append("\n");
