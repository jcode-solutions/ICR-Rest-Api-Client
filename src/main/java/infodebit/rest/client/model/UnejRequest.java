...
public class UnejRequest {
  public static final String SERIALIZED_NAME_PARTICIPANT_CODE = "participantCode";
  @SerializedName(SERIALIZED_NAME_PARTICIPANT_CODE)
  private String participantCode;

  public static final String SERIALIZED_NAME_TEMEI_SOLICITARE = "temeiSolicitare";
  @SerializedName(SERIALIZED_NAME_TEMEI_SOLICITARE)
  private String temeiSolicitare;
  ...
  public UnejRequest participantCode(String participantCode) {
   ...
   /**
   * Codul unic al solicitantului, numele și prenumele
   * @return participantCode
  **/
  @ApiModelProperty(required = true, value = "Codul unic al solicitantului, numele și prenumele")
  ...
  public UnejRequest temeiSolicitare(String temeiSolicitare) {
    
    this.temeiSolicitare = temeiSolicitare;
    return this;
  }

   /**
   * Temeiul legal al solicitării
   * @return temeiSolicitare
  **/
  @ApiModelProperty(required = true, value = "Temeiul legal al solicitării")

  public String getTemeiSolicitare() {
    return temeiSolicitare;
  }


  public void setTemeiSolicitare(String temeiSolicitare) {
    this.temeiSolicitare = temeiSolicitare;
  }


  public UnejRequest debtorIdentityNr(String debtorIdentityNr) {
   ...
   /**
   * IDN entitătii verificate
   * @return debtorIdentityNr
  **/
  @ApiModelProperty(required = true, value = "IDN entitătii verificate")
  ...
  public boolean equals(Object o) {
    ...
    UnejRequest unejRequest = (UnejRequest) o;
    return Objects.equals(this.participantCode, unejRequest.participantCode) &&
        Objects.equals(this.temeiSolicitare, unejRequest.temeiSolicitare) &&
        Objects.equals(this.debtorIdentityNr, unejRequest.debtorIdentityNr);
  }

  @Override
  public int hashCode() {
    return Objects.hash(participantCode, temeiSolicitare, debtorIdentityNr);
  }
  ...
  public String toString() {
    ...
    sb.append("class UnejRequest {\n");
    sb.append("    participantCode: ").append(toIndentedString(participantCode)).append("\n");
    sb.append("    temeiSolicitare: ").append(toIndentedString(temeiSolicitare)).append("\n");
