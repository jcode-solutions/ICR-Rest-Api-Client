...
/**
 * EntityModelEntityModelDebtPaymentDTO
 */
...
public class EntityModelEntityModelDebtPaymentDTO {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private Long id;

  public static final String SERIALIZED_NAME_DEBT_ID = "debtId";
  @SerializedName(SERIALIZED_NAME_DEBT_ID)
  private Long debtId;
  ...
  public static final String SERIALIZED_NAME_PAYMENT_CALCULATION = "paymentCalculation";
  @SerializedName(SERIALIZED_NAME_PAYMENT_CALCULATION)
  private Float paymentCalculation;

  public static final String SERIALIZED_NAME_PAYMENT_PAY = "paymentPay";
  @SerializedName(SERIALIZED_NAME_PAYMENT_PAY)
  private Float paymentPay;
  ...
  public static final String SERIALIZED_NAME_TOTAL_REMAINING = "totalRemaining";
  @SerializedName(SERIALIZED_NAME_TOTAL_REMAINING)
  private Float totalRemaining;

  public static final String SERIALIZED_NAME_FIRST_DELINQUENCY_DATE = "firstDelinquencyDate";
  @SerializedName(SERIALIZED_NAME_FIRST_DELINQUENCY_DATE)
  private OffsetDateTime firstDelinquencyDate;
  ...
  public EntityModelEntityModelDebtPaymentDTO id(Long id) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO debtId(Long debtId) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO invoiceDate(OffsetDateTime invoiceDate) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO paymentDate(OffsetDateTime paymentDate) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO paymentCalculation(Float paymentCalculation) {
  ...
  **/
  ...
  public Float getPaymentCalculation() {
    return paymentCalculation;
  }


  public void setPaymentCalculation(Float paymentCalculation) {
    this.paymentCalculation = paymentCalculation;
  }


  public EntityModelEntityModelDebtPaymentDTO paymentPay(Float paymentPay) {
  ...
  **/
  ...
  public Float getPaymentPay() {
    return paymentPay;
  }


  public void setPaymentPay(Float paymentPay) {
    this.paymentPay = paymentPay;
  }


  public EntityModelEntityModelDebtPaymentDTO ratio(Float ratio) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO remaining(Float remaining) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO totalRemaining(Float totalRemaining) {
  ...
  **/
  ...
  public EntityModelEntityModelDebtPaymentDTO firstDelinquencyDate(OffsetDateTime firstDelinquencyDate) {
  ...
  **/
  ...
  public OffsetDateTime getFirstDelinquencyDate() {
    return firstDelinquencyDate;
  }


  public void setFirstDelinquencyDate(OffsetDateTime firstDelinquencyDate) {
    this.firstDelinquencyDate = firstDelinquencyDate;
  }


  public EntityModelEntityModelDebtPaymentDTO links(List<Link> links) {
    
    this.links = links;
    return this;
  }

  public EntityModelEntityModelDebtPaymentDTO addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    EntityModelEntityModelDebtPaymentDTO entityModelEntityModelDebtPaymentDTO = (EntityModelEntityModelDebtPaymentDTO) o;
    return Objects.equals(this.id, entityModelEntityModelDebtPaymentDTO.id) &&
        Objects.equals(this.debtId, entityModelEntityModelDebtPaymentDTO.debtId) &&
        Objects.equals(this.invoiceDate, entityModelEntityModelDebtPaymentDTO.invoiceDate) &&
        Objects.equals(this.paymentDate, entityModelEntityModelDebtPaymentDTO.paymentDate) &&
        Objects.equals(this.paymentCalculation, entityModelEntityModelDebtPaymentDTO.paymentCalculation) &&
        Objects.equals(this.paymentPay, entityModelEntityModelDebtPaymentDTO.paymentPay) &&
        Objects.equals(this.ratio, entityModelEntityModelDebtPaymentDTO.ratio) &&
        Objects.equals(this.remaining, entityModelEntityModelDebtPaymentDTO.remaining) &&
        Objects.equals(this.totalRemaining, entityModelEntityModelDebtPaymentDTO.totalRemaining) &&
        Objects.equals(this.firstDelinquencyDate, entityModelEntityModelDebtPaymentDTO.firstDelinquencyDate) &&
        Objects.equals(this.links, entityModelEntityModelDebtPaymentDTO.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, debtId, invoiceDate, paymentDate, paymentCalculation, paymentPay, ratio, remaining, totalRemaining, firstDelinquencyDate, links);
  }
  ...
  public String toString() {
    ...
    sb.append("class EntityModelEntityModelDebtPaymentDTO {\n");
    sb.append("    id: ").append(toIndentedString(id)).append("\n");
    sb.append("    debtId: ").append(toIndentedString(debtId)).append("\n");
    sb.append("    invoiceDate: ").append(toIndentedString(invoiceDate)).append("\n");
    sb.append("    paymentDate: ").append(toIndentedString(paymentDate)).append("\n");
    sb.append("    paymentCalculation: ").append(toIndentedString(paymentCalculation)).append("\n");
    sb.append("    paymentPay: ").append(toIndentedString(paymentPay)).append("\n");
