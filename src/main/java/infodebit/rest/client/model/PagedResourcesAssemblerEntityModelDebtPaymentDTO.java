...
/**
 * PagedResourcesAssemblerEntityModelDebtPaymentDTO
 */
...
public class PagedResourcesAssemblerEntityModelDebtPaymentDTO {
  public static final String SERIALIZED_NAME_FORCE_FIRST_AND_LAST_RELS = "forceFirstAndLastRels";
  @SerializedName(SERIALIZED_NAME_FORCE_FIRST_AND_LAST_RELS)
  private Boolean forceFirstAndLastRels;


  public PagedResourcesAssemblerEntityModelDebtPaymentDTO forceFirstAndLastRels(Boolean forceFirstAndLastRels) {
   ...
   /**
   * Get forceFirstAndLastRels
   * @return forceFirstAndLastRels
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "")

  public Boolean getForceFirstAndLastRels() {
    return forceFirstAndLastRels;
  }
  ...
  public boolean equals(Object o) {
    ...
    PagedResourcesAssemblerEntityModelDebtPaymentDTO pagedResourcesAssemblerEntityModelDebtPaymentDTO = (PagedResourcesAssemblerEntityModelDebtPaymentDTO) o;
    return Objects.equals(this.forceFirstAndLastRels, pagedResourcesAssemblerEntityModelDebtPaymentDTO.forceFirstAndLastRels);
  }

  @Override
  public int hashCode() {
    return Objects.hash(forceFirstAndLastRels);
  }
  ...
  public String toString() {
    ...
    sb.append("class PagedResourcesAssemblerEntityModelDebtPaymentDTO {\n");
    sb.append("    forceFirstAndLastRels: ").append(toIndentedString(forceFirstAndLastRels)).append("\n");
    sb.append("}");
    return sb.toString();
  }
