...
import infodebit.rest.client.model.OAuth2AccessToken;
...
public class TokenEndpointApi {
     ...
     */
    public okhttp3.Call getAccessTokenCall(Map<String, String> parameters, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getAccessTokenValidateBeforeCall(Map<String, String> parameters, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling getAccessToken(Async)");
        }
        

        okhttp3.Call localVarCall = getAccessTokenCall(parameters, _callback);
        return localVarCall;
     ...
     */
    public OAuth2AccessToken getAccessToken(Map<String, String> parameters) throws ApiException {
        ApiResponse<OAuth2AccessToken> localVarResp = getAccessTokenWithHttpInfo(parameters);
     ...
     */
    public ApiResponse<OAuth2AccessToken> getAccessTokenWithHttpInfo(Map<String, String> parameters) throws ApiException {
        okhttp3.Call localVarCall = getAccessTokenValidateBeforeCall(parameters, null);
     ...
     */
    public okhttp3.Call getAccessTokenAsync(Map<String, String> parameters, final ApiCallback<OAuth2AccessToken> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccessTokenValidateBeforeCall(parameters, _callback);
        Type localVarReturnType = new TypeToken<OAuth2AccessToken>(){}.getType();
     ...
     */
    public okhttp3.Call postAccessTokenCall(Map<String, String> parameters, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postAccessTokenValidateBeforeCall(Map<String, String> parameters, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'parameters' is set
        if (parameters == null) {
            throw new ApiException("Missing the required parameter 'parameters' when calling postAccessToken(Async)");
        }
        

        okhttp3.Call localVarCall = postAccessTokenCall(parameters, _callback);
        return localVarCall;
     ...
     */
    public OAuth2AccessToken postAccessToken(Map<String, String> parameters) throws ApiException {
        ApiResponse<OAuth2AccessToken> localVarResp = postAccessTokenWithHttpInfo(parameters);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OAuth2AccessToken> postAccessTokenWithHttpInfo(Map<String, String> parameters) throws ApiException {
        okhttp3.Call localVarCall = postAccessTokenValidateBeforeCall(parameters, null);
        Type localVarReturnType = new TypeToken<OAuth2AccessToken>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postAccessTokenAsync(Map<String, String> parameters, final ApiCallback<OAuth2AccessToken> _callback) throws ApiException {

        okhttp3.Call localVarCall = postAccessTokenValidateBeforeCall(parameters, _callback);
        Type localVarReturnType = new TypeToken<OAuth2AccessToken>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
