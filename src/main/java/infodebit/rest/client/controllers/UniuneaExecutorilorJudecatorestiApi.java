...
import infodebit.rest.client.model.ExecutionProcedureDTO;
import infodebit.rest.client.model.UnejRequest;
...
public class UniuneaExecutorilorJudecatorestiApi {
    private ApiClient localVarApiClient;

    public UniuneaExecutorilorJudecatorestiApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UniuneaExecutorilorJudecatorestiApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getInformationFromUNEJ
     * @param unejRequest  (required)
     ...
     */
    public okhttp3.Call getInformationFromUNEJCall(UnejRequest unejRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = unejRequest;

        // create path and map variables
        String localVarPath = "/unej";
    ...
    private okhttp3.Call getInformationFromUNEJValidateBeforeCall(UnejRequest unejRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'unejRequest' is set
        if (unejRequest == null) {
            throw new ApiException("Missing the required parameter 'unejRequest' when calling getInformationFromUNEJ(Async)");
        }
        

        okhttp3.Call localVarCall = getInformationFromUNEJCall(unejRequest, _callback);
        return localVarCall;

    }

    /**
     * Get information from UNEJ
     * 
     * @param unejRequest  (required)
     * @return List&lt;ExecutionProcedureDTO&gt;
     ...
     */
    public List<ExecutionProcedureDTO> getInformationFromUNEJ(UnejRequest unejRequest) throws ApiException {
        ApiResponse<List<ExecutionProcedureDTO>> localVarResp = getInformationFromUNEJWithHttpInfo(unejRequest);
     ...
     * 
     * @param unejRequest  (required)
     * @return ApiResponse&lt;List&lt;ExecutionProcedureDTO&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ExecutionProcedureDTO>> getInformationFromUNEJWithHttpInfo(UnejRequest unejRequest) throws ApiException {
        okhttp3.Call localVarCall = getInformationFromUNEJValidateBeforeCall(unejRequest, null);
        Type localVarReturnType = new TypeToken<List<ExecutionProcedureDTO>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get information from UNEJ (asynchronously)
     * 
     * @param unejRequest  (required)
     ...
     */
    public okhttp3.Call getInformationFromUNEJAsync(UnejRequest unejRequest, final ApiCallback<List<ExecutionProcedureDTO>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getInformationFromUNEJValidateBeforeCall(unejRequest, _callback);
        Type localVarReturnType = new TypeToken<List<ExecutionProcedureDTO>>(){}.getType();
