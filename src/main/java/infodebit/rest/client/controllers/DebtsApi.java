...
public class DebtsApi {
     ...
     */
    public okhttp3.Call allForDebtorCall(String idnp, Pageable pageable, PagedResourcesAssemblerEntityModelDebtDTO pageAssembler, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/persons/{idnp}/debts"
            .replaceAll("\\{" + "idnp" + "\\}", localVarApiClient.escapeString(idnp.toString()));
    ...
    private okhttp3.Call allForDebtorValidateBeforeCall(String idnp, Pageable pageable, PagedResourcesAssemblerEntityModelDebtDTO pageAssembler, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'idnp' is set
        if (idnp == null) {
            throw new ApiException("Missing the required parameter 'idnp' when calling allForDebtor(Async)");
        }
        
        // verify the required parameter 'pageable' is set
        if (pageable == null) {
            throw new ApiException("Missing the required parameter 'pageable' when calling allForDebtor(Async)");
        }
        
        // verify the required parameter 'pageAssembler' is set
        if (pageAssembler == null) {
            throw new ApiException("Missing the required parameter 'pageAssembler' when calling allForDebtor(Async)");
        }
        

        okhttp3.Call localVarCall = allForDebtorCall(idnp, pageable, pageAssembler, _callback);
        return localVarCall;

    }

    /**
     * Get all debts of a person
     * 
     * @param idnp  (required)
     * @param pageable  (required)
     * @param pageAssembler  (required)
     * @return PagedModelEntityModelEntityModelDebtDTO
     ...
     */
    public PagedModelEntityModelEntityModelDebtDTO allForDebtor(String idnp, Pageable pageable, PagedResourcesAssemblerEntityModelDebtDTO pageAssembler) throws ApiException {
        ApiResponse<PagedModelEntityModelEntityModelDebtDTO> localVarResp = allForDebtorWithHttpInfo(idnp, pageable, pageAssembler);
     ...
     * @param pageable  (required)
     * @param pageAssembler  (required)
     * @return ApiResponse&lt;PagedModelEntityModelEntityModelDebtDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedModelEntityModelEntityModelDebtDTO> allForDebtorWithHttpInfo(String idnp, Pageable pageable, PagedResourcesAssemblerEntityModelDebtDTO pageAssembler) throws ApiException {
        okhttp3.Call localVarCall = allForDebtorValidateBeforeCall(idnp, pageable, pageAssembler, null);
        Type localVarReturnType = new TypeToken<PagedModelEntityModelEntityModelDebtDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get all debts of a person (asynchronously)
     * 
     * @param idnp  (required)
     * @param pageable  (required)
     * @param pageAssembler  (required)
     ...
     */
    public okhttp3.Call allForDebtorAsync(String idnp, Pageable pageable, PagedResourcesAssemblerEntityModelDebtDTO pageAssembler, final ApiCallback<PagedModelEntityModelEntityModelDebtDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = allForDebtorValidateBeforeCall(idnp, pageable, pageAssembler, _callback);
        Type localVarReturnType = new TypeToken<PagedModelEntityModelEntityModelDebtDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for deleteDebt
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call deleteDebtCall(Long id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/debts/{id}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteDebtValidateBeforeCall(Long id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling deleteDebt(Async)");
        }
        

        okhttp3.Call localVarCall = deleteDebtCall(id, _callback);
        return localVarCall;
     ...
     */
    public void deleteDebt(Long id) throws ApiException {
        deleteDebtWithHttpInfo(id);
    }
     ...
     */
    public ApiResponse<Void> deleteDebtWithHttpInfo(Long id) throws ApiException {
        okhttp3.Call localVarCall = deleteDebtValidateBeforeCall(id, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete a debt (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteDebtAsync(Long id, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteDebtValidateBeforeCall(id, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
     * Build call for getDebtById
     * @param id  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getDebtByIdCall(Long id, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDebtByIdValidateBeforeCall(Long id, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling getDebtById(Async)");
        }
        

        okhttp3.Call localVarCall = getDebtByIdCall(id, _callback);
        return localVarCall;
     ...
     */
    public EntityModelDebtDTO getDebtById(Long id) throws ApiException {
        ApiResponse<EntityModelDebtDTO> localVarResp = getDebtByIdWithHttpInfo(id);
        return localVarResp.getData();
    }
     ...
     * 
     * @param id  (required)
     * @return ApiResponse&lt;EntityModelDebtDTO&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<EntityModelDebtDTO> getDebtByIdWithHttpInfo(Long id) throws ApiException {
        okhttp3.Call localVarCall = getDebtByIdValidateBeforeCall(id, null);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get a debt by id (asynchronously)
     * 
     * @param id  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getDebtByIdAsync(Long id, final ApiCallback<EntityModelDebtDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = getDebtByIdValidateBeforeCall(id, _callback);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for newDebt
     * @param idnp  (required)
     * @param debtDTO  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call newDebtCall(String idnp, DebtDTO debtDTO, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = debtDTO;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call newDebtValidateBeforeCall(String idnp, DebtDTO debtDTO, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'idnp' is set
        if (idnp == null) {
            throw new ApiException("Missing the required parameter 'idnp' when calling newDebt(Async)");
        }
        
        // verify the required parameter 'debtDTO' is set
        if (debtDTO == null) {
            throw new ApiException("Missing the required parameter 'debtDTO' when calling newDebt(Async)");
        }
        

        okhttp3.Call localVarCall = newDebtCall(idnp, debtDTO, _callback);
        return localVarCall;
     ...
     */
    public EntityModelDebtDTO newDebt(String idnp, DebtDTO debtDTO) throws ApiException {
        ApiResponse<EntityModelDebtDTO> localVarResp = newDebtWithHttpInfo(idnp, debtDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EntityModelDebtDTO> newDebtWithHttpInfo(String idnp, DebtDTO debtDTO) throws ApiException {
        okhttp3.Call localVarCall = newDebtValidateBeforeCall(idnp, debtDTO, null);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Add a debt (asynchronously)
     * 
     * @param idnp  (required)
     * @param debtDTO  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call newDebtAsync(String idnp, DebtDTO debtDTO, final ApiCallback<EntityModelDebtDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = newDebtValidateBeforeCall(idnp, debtDTO, _callback);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updateDebt
     * @param id  (required)
     * @param debtDTO  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call updateDebtCall(Long id, DebtDTO debtDTO, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = debtDTO;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateDebtValidateBeforeCall(Long id, DebtDTO debtDTO, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling updateDebt(Async)");
        }
        
        // verify the required parameter 'debtDTO' is set
        if (debtDTO == null) {
            throw new ApiException("Missing the required parameter 'debtDTO' when calling updateDebt(Async)");
        }
        

        okhttp3.Call localVarCall = updateDebtCall(id, debtDTO, _callback);
        return localVarCall;
     ...
     */
    public EntityModelDebtDTO updateDebt(Long id, DebtDTO debtDTO) throws ApiException {
        ApiResponse<EntityModelDebtDTO> localVarResp = updateDebtWithHttpInfo(id, debtDTO);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<EntityModelDebtDTO> updateDebtWithHttpInfo(Long id, DebtDTO debtDTO) throws ApiException {
        okhttp3.Call localVarCall = updateDebtValidateBeforeCall(id, debtDTO, null);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update a debt (asynchronously)
     * 
     * @param id  (required)
     * @param debtDTO  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateDebtAsync(Long id, DebtDTO debtDTO, final ApiCallback<EntityModelDebtDTO> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateDebtValidateBeforeCall(id, debtDTO, _callback);
        Type localVarReturnType = new TypeToken<EntityModelDebtDTO>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
